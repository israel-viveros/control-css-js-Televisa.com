 ...
 */
$(function() {
	var nextObj = $("#dock-stage").find("li").eq(1);
    nextObj.addClass("active");
    nextObj.find("a").animate({'marginTop': '-60px'}, 500);
    nextObj.find("a span").fadeOut(500);
        ...
        scroll: {
            ...
            onAfter: function(data) {
                ...
                $("#dock-stage ul li").each(function() {
                    $(this).children("a").find("span").removeClass('bg-television bg-noticieros bg-deportes bg-lifestyle bg-entretenimiento bg-corporativo bg-ninos bg-esmas');
