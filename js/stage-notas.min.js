        ...
        scroll: {
            ...
            onAfter: function(data) {
                ...
                switch(src0)
                    {
                    case 1:
                      NuevaClase = "bg-television";
                      break;
                    case 2:
                      NuevaClase = "bg-noticieros";
                      break;
                    case 3:
                      NuevaClase = "bg-deportes";
                      break;
                    case 4:
                      NuevaClase = "bg-lifestyle";
                      break;
                    case 5:
                      NuevaClase = "bg-entretenimiento";
                      break;
                    case 6:
                      NuevaClase = "bg-television";
                      break;
                ...
                $("#dock-stage ul li").each(function() {
                    $(this).children("a").find("span").removeClass('bg-television bg-noticieros bg-deportes bg-lifestyle bg-entretenimiento bg-television');                                                            
